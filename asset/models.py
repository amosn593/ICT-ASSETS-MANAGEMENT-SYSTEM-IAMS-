...
class Profile_2(models.Model):
    ...
    def __str__(self):
        return f"{self.name}, - {self.user.username} - {self.region}"
...
class Monitor(models.Model):
    ...
    monitor_cpu = models.CharField(max_length=30, null=True, blank=True, default=None)
    cpu_assigned = models.CharField(max_length=5,default='Yes', null=False)
    date_deployed = models.DateField(auto_now_add=True)
    deployed_by = models.CharField(max_length=30, null=True, blank=True, default=None)
    date_changed = models.DateField(null=True, blank=True, default=None)
    reason_changed = models.CharField(max_length=60, null=True, blank=True, default=None)
    changed_by = models.CharField(max_length=30, null=True, blank=True, default=None)
    status = models.CharField(max_length=15, default='WORKING')
    ticket_number = models.CharField(max_length=30, null=True, blank=True, default=None)
...
class Client(models.Model):
    ...
    hod_approval = models.CharField(max_length=10, null=False,default='Pending')
    ...
    hod = models.ForeignKey(Hod, null=True,blank=True, default=None ,on_delete=models.SET_NULL)
    assigned_by = models.CharField(max_length=30, null=False)
    ticket = models.CharField(max_length=30, null=True,blank=True, default=None)
...
class Comp(models.Model):
    ...
    reason_no_domain = models.CharField(max_length=30, blank=True, default=None)
    ...
    reason_no_kaspersky = models.CharField(max_length=30, blank=True, default=None)
    ...
    ict_approval = models.CharField(max_length=30, null=False, default='Pending')
    reject_reason = models.CharField(max_length=50,null=True, blank=True, default=None)
    approved_by = models.CharField(max_length=40, null=True, blank=True, default=None)
    ticket = models.ForeignKey(Ticket,max_length=30,null=True,on_delete=models.SET_NULL)
    deployed_date = models.DateField(auto_now_add=True)
    obso_date = models.DateField(null=True, blank=True, default=None)
    obso_reason = models.CharField(max_length=50,null=True, blank=True, default=None)
    obso_officer = models.CharField(max_length=40, null=True, blank=True, default=None)
...
class Repair(models.Model):
    ...
    officer_assigned = models.ForeignKey(User, null=True ,on_delete=models.SET_NULL)
    ticket_number = models.CharField(max_length=30, null=False)
    ...
    rdate = models.DateField(null=True, blank=True, default=datetime(1900,1,1))
